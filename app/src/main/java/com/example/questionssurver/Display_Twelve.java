...
public class Display_Twelve extends AppCompatActivity {
    ...
    public void btn_one_onclick(View view)
    {
        ...
        if(edt_email.getText().toString().trim().equals("")) {
            ...
            intent1.setClass(Display_Twelve.this, Thankyou.class);
