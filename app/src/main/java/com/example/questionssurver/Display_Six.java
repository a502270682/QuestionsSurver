...
public class Display_Six extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display__six);
        ...
        Rdgroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    case R.id.Rd_Six_B:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Six_B);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Six_A:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Six_A);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Six_C:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Six_C);
                        answer = (String) SelectButton.getText();
                        break;
                }
                flag = 1;
    ...
    public void btn_one_onclick(View view)
    {
        if(flag==1) {
            ...
            intent1.setClass(Display_Six.this, Display_Seven.class);
