...
public class Display_Four extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display__four);
        ...
        Rdgroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    case R.id.Rd_Four_B:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Four_B);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Four_A:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Four_A);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Four_C:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Four_C);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Four_D:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Four_D);
                        answer = (String) SelectButton.getText();
                        break;
                }
                flag = 1;
    ...
    public void btn_one_onclick(View view)
    {
        if(flag==1) {
            ...
            intent1.setClass(Display_Four.this, Display_Five.class);
