...
public class Display_Five extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display__five);
        ...
        Rdgroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    case R.id.Rd_Five_B:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Five_B);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Five_A:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Five_A);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Five_C:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Five_C);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Five_D:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Five_D);
                        answer = (String) SelectButton.getText();
                        break;
                }
                flag = 1;
    ...
    public void btn_one_onclick(View view)
    {
        if(flag==1) {
            ...
            intent1.setClass(Display_Five.this, Display_Six.class);
