...
public class Display_Nine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display__nine);
        ...
        Rdgroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    case R.id.Rd_Nine_B:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Nine_B);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Nine_A:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Nine_A);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Nine_C:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Nine_C);
                        answer = (String) SelectButton.getText();
                        break;
                }
                flag = 1;
    ...
    public void btn_one_onclick(View view)
    {
        if(flag==1) {
            ...
            intent1.setClass(Display_Nine.this, Display_Ten.class);
