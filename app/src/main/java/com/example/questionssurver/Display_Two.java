...
public class Display_Two extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display__two);
        ...
        Rdgroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    case R.id.Rd_Two_B:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Two_B);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Two_A:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Two_A);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Two_C:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Two_C);
                        answer = (String) SelectButton.getText();
                        break;
                    case R.id.Rd_Two_D:
                        SelectButton = (RadioButton) findViewById(R.id.Rd_Two_D);
                        answer = (String) SelectButton.getText();
                        break;
                }
                flag = 1;
    ...
    public void btn_one_onclick(View view)
    {
        if(flag==1) {
            ...
            intent1.setClass(Display_Two.this, Display_Three.class);
